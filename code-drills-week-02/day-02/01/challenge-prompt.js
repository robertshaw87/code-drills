...
// set the `farm` variable to be an array with the elements
...
// using string concatenation, console log out the sentence 
//"I drive Farley around San Francisco in my Prius" without explicitly 
...
// and if `computerCost` is greater than the sum of `rentCost` and `utilitiesCost`
